...
const SignUp = () => {
  ...
  return (
    <View style={styles.signUpView}>
      ...
      />
      <View style={[styles.pageHeaderView, styles.mt29]}>
        <TouchableOpacity
      ...
      <TextInput
        style={[styles.inputTextTextInput, styles.mt29]}
        placeholder="Name"
        keyboardType="default"
        placeholderTextColor="#bdbdbd"
      />
      <TextInput
        style={[styles.inputTextTextInput1, styles.mt29]}
        placeholder="Email"
        keyboardType="default"
        placeholderTextColor="#bdbdbd"
      />
      <TextInput
        style={[styles.inputTextTextInput2, styles.mt29]}
        ...
        placeholderTextColor="#bdbdbd"
      />
      <View style={[styles.checkboxOptionEmptyView, styles.mt29]}>
        ...
        <Text style={styles.iWouldLikeToReceiveYourN}>
          I would like to receive your newsletter and other promotional
          information.
        </Text>
      </View>
      <Pressable style={[styles.buttonPrimaryPressable, styles.mt29]}>
        <Text style={styles.signUpText1}>Sign Up</Text>
      </Pressable>
      <Text style={[styles.forgotYourPassword, styles.mt29]}>
        Forgot your password?
      </Text>
      <View style={[styles.iOSKeyboardLightAlphabeticView, styles.mt29]}>
